...
public class Vector3d implements IPosition {
    ...
    public static Vector3d fromRGB24(int p_237487_0_) {
        double d0 = (double)(p_237487_0_ >> 16 & 255) / 255.0;
        double d1 = (double)(p_237487_0_ >> 8 & 255) / 255.0;
        double d2 = (double)(p_237487_0_ & 255) / 255.0;
        return new Vector3d(d0, d1, d2);
    }

    public static Vector3d atCenterOf(Vector3i p_237489_0_) {
        return new Vector3d((double)p_237489_0_.getX() + 0.5, (double)p_237489_0_.getY() + 0.5, (double)p_237489_0_.getZ() + 0.5);
    }
    ...
    public static Vector3d atBottomCenterOf(Vector3i p_237492_0_) {
        return new Vector3d((double)p_237492_0_.getX() + 0.5, (double)p_237492_0_.getY(), (double)p_237492_0_.getZ() + 0.5);
    }

    public static Vector3d upFromBottomCenterOf(Vector3i p_237490_0_, double p_237490_1_) {
        return new Vector3d((double)p_237490_0_.getX() + 0.5, (double)p_237490_0_.getY() + p_237490_1_, (double)p_237490_0_.getZ() + 0.5);
    }
    ...
    public Vector3d align(EnumSet<Direction.Axis> p_197746_1_) {
        double d0 = p_197746_1_.contains(Axis.X) ? (double)MathHelper.floor(this.x) : this.x;
        double d1 = p_197746_1_.contains(Axis.Y) ? (double)MathHelper.floor(this.y) : this.y;
        double d2 = p_197746_1_.contains(Axis.Z) ? (double)MathHelper.floor(this.z) : this.z;
        return new Vector3d(d0, d1, d2);
    }
