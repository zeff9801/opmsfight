...
public class TrailInfo {
    ...
    public static TrailInfo deserialize(JsonElement json) {
        ...
        if (trailObj.has("particle_type")) {
            ...
            ParticleType particleType = ForgeRegistries.PARTICLE_TYPES.getValue(new ResourceLocation(particleTypeName));
    ...
    public static class Builder {
        ...
        public TrailInfo.Builder type(ParticleType particle) {
