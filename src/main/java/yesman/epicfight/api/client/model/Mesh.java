...
public abstract class Mesh<P extends ModelPart<V>, V extends VertexBuilder> {
	...
	public interface DrawingFunction {
		...
		public void draw(IVertexBuilder builder, float posX, float posY, float posZ, float normX, float normY, float normZ, int packedLight, float r, float g, float b, float a, float u, float v, int overlay);
	}
}