...
public class MobPatchReloadListener extends JsonReloadListener {
	...
	protected void apply(Map<ResourceLocation, JsonElement> objectIn, IResourceManager resourceManagerIn, IProfiler profilerIn) {
		for (Map.Entry<ResourceLocation, JsonElement> entry : objectIn.entrySet()) {
			...
			if (!ForgeRegistries.ENTITIES.containsKey(registryName)) {
                EpicFightMod.LOGGER.warn("[Custom Entity] Entity named {} does not exist", registryName);
				continue;
			}
	...
	public static <T extends MobPatch<?>> BehaviorPredicate<T> deserializeBehaviorPredicate(String type, CompoundNBT args) {
