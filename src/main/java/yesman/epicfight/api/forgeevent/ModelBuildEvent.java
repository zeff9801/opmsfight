...
public abstract class ModelBuildEvent<T> extends Event implements IModBusEvent {
	...
	public static class MeshBuild extends ModelBuildEvent<Mesh<?, ?>> {
		...
		public <M extends RawMesh> M getRaw(String modid, String path, MeshContructor<RawMesh.RawModelPart, VertexBuilder, M> constructor) {
			return Meshes.getOrCreateRawMesh(this.resourceManager, new ResourceLocation(modid, path), constructor);
		}

		public <M extends AnimatedMesh> M getAnimated(String modid, String path, MeshContructor<AnimatedMesh.AnimatedModelPart, AnimatedVertexBuilder, M> constructor) {
