...
public abstract class TexturedCustomModelParticle extends CustomModelParticle {
	...
	public TexturedCustomModelParticle(ClientWorld level, double x, double y, double z, double xd, double yd, double zd, Mesh.RawMesh particleMesh, ResourceLocation texture) {
