...
public class LayerUtil {
	@FunctionalInterface
	public interface LayerProvider<E extends LivingEntity, T extends LivingEntityPatch<E>, M extends EntityModel<E>, R extends LivingRenderer<E, M>, AM extends AnimatedMesh> {
		PatchedLayer<E, T, M, ? extends LayerRenderer<E, M>> getLayer(JsonObject properties);
	}
	
	public static <E extends LivingEntity, T extends LivingEntityPatch<E>, M extends EntityModel<E>, R extends LivingRenderer<E, M>, AM extends AnimatedMesh> void addLayer(yesman.epicfight.client.renderer.LayerRenderer<E, T, M> renderer, EntityType<?> entityType, List<Pair<ResourceLocation, JsonElement>> layers) {
		...
		for (Pair<ResourceLocation, JsonElement> entry : layers) {
			try {
				...
				PatchedLayer<E, T, M, ? extends LayerRenderer<E, M>> patchedLayer = layerAdder.getLayer(jsonobj);
	...
	private static <E extends LivingEntity, T extends LivingEntityPatch<E>, M extends EntityModel<E>, R extends LivingRenderer<E, M>, AM extends AnimatedMesh> PatchedLayer<E, T, M, ? extends LayerRenderer<E, M>> getInvisibleLayer(JsonObject properties) {
	...
	private static <E extends LivingEntity, T extends LivingEntityPatch<E>, M extends EntityModel<E>, R extends LivingRenderer<E, M>, AM extends AnimatedMesh> PatchedLayer<E, T, M, ? extends LayerRenderer<E, M>> getEyesLayer(JsonObject properties) {
	...
	private static <E extends LivingEntity, T extends LivingEntityPatch<E>, M extends EntityModel<E>, R extends LivingRenderer<E, M>, AM extends AnimatedMesh> PatchedLayer<E, T, M, ? extends LayerRenderer<E, M>> getOriginalModelLayer(JsonObject properties) {
		if ("none".equals(properties.get("target_layer").getAsString())) {
